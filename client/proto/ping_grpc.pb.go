...
const (
	TestService_Ping_FullMethodName        = "/ping.TestService/Ping"
	TestService_GetHostInfo_FullMethodName = "/ping.TestService/GetHostInfo"
)
...
type TestServiceClient interface {
	...
	GetHostInfo(ctx context.Context, in *HostRequest, opts ...grpc.CallOption) (*HostResponse, error)
}
...
func (c *testServiceClient) GetHostInfo(ctx context.Context, in *HostRequest, opts ...grpc.CallOption) (*HostResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HostResponse)
	err := c.cc.Invoke(ctx, TestService_GetHostInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TestServiceServer interface {
	...
	GetHostInfo(context.Context, *HostRequest) (*HostResponse, error)
...
func (UnimplementedTestServiceServer) GetHostInfo(context.Context, *HostRequest) (*HostResponse, error) {
...
func _TestService_GetHostInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HostRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TestServiceServer).GetHostInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TestService_GetHostInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestServiceServer).GetHostInfo(ctx, req.(*HostRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TestService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TestService_GetHostInfo_Handler,
		},
	},
